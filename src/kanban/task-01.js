...
let idCount = Number(localStorage.getItem("id-count"));
const blocks = {
...
const addButtons = {
  backlog: document.querySelector('[add-task-button=backlog]'),
  ready: document.querySelector('[add-task-button=ready]'),
  inProgress: document.querySelector('[add-task-button=inProgress]'),
  finished: document.querySelector('[add-task-button=finished]'),
};
